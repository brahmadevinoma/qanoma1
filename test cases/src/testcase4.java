	...
	public static void main(String[] args) throws Exception 
	{
		...
		/*		
			...
			// verify employee information
				...
				// delete the employee id name
			WebElement delete=driver.findElement(By.xpath("//table[@class='data-table']/descendant::td[contains(text(),'"+ empID +"')]/preceding-sibling::td/input"));
			...
			// verify Select the field to search! and click ok
			
			if(A.getText().equals("Select the field to search!"))
			{
				System.out.println("Select the field to search! displayed");
			    A.accept();
			}
			    else
			    {
			    	System.out.println("Select the field to search! not displayed");
			    }
				
			// click on delete
			
			driver.findElement(By.xpath("//input[@type='button'][@onclick='returnDelete();']")).click();
			Thread.sleep(2000);
			
			// verify deleted information successfully
	    String DELSUCC=driver.findElement(By.xpath("//div[@class='messagebar']/span")).getText();
	    if(DELSUCC.equals("Successfully Deleted"))
	    {
	    	System.out.println("Successfully Deleted displayed");
	    }
	    else
	    {
	    	System.out.println("Successfully Deleted not displayed");
	    }
