	...
	public static void main(String[] args) throws Exception 
	{
		...
		// verify change password and logout
			...
			// verify that location is successfully added
				...
				driver.findElement(By.linkText("noma")).click();
				Thread.sleep(2000);
			   ...
			   //edit that name
				...
				WebElement NAME1=driver.findElement(By.id("txtLocDescription"));
				NAME1.click();
				NAME1.clear();
				NAME1.sendKeys("nomadeva");
				WebElement SAVE1=driver.findElement(By.id("editBtn"));
				SAVE1.click();
				...
				WebElement DELETE1=driver.findElement(By.name("plainbtn"));
				DELETE1.click();
